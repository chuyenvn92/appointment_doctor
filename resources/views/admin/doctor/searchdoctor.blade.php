            ...
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        ...
                        <span>Tìm thấy {{ count($users) }} bác sĩ</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
    ...
    <div class="d-flex justify-content-between">
        <form method="POST" role="search" action="{{ route('search.doctor') }}">
            ...
            <div class="input-group rounded">
                <input type="search" class="form-control ml-4 rounded" value="{{ $item }}" name="searchDoctor"
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            @if (count($users) > 0)
                                ...
                                @endforeach
                            @else
                                <td>Không có bác sĩ với tên "<b>{{ $item }}</b>"</td>
                            @endif
